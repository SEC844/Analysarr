...
export const en: Dictionary = {
  ...
  ignore: {
    options: "Options",
    ignoreTorrent: "Ignore this torrent…",
    ignoreTorrentTitle: "Ignore this torrent",
    ignoreTorrentDescription:
      "It will no longer be reported as orphan or not hardlinked, and neither Clean up, Repair nor automations will touch it. If its situation changes, it is reported again automatically.",
    unignore: "Stop ignoring",
    ignored: "Ignored",
    ignoredHint: "Ignored: reported again automatically if its situation changes.",
    keepFile: "Keep on purpose…",
    keepFileTitle: "Keep this file on purpose",
    keepFileDescription:
      "It will no longer count as a duplicate and will never be cleaned up — for instance a dubbed and a subtitled version side by side. If it is replaced, the alert comes back automatically; a new duplicate is still reported.",
    unkeepFile: "Stop keeping",
    kept: "Kept on purpose",
    keptHint: "Kept on purpose: reported again automatically if it changes.",
    muteAlert: "Hide “{status}”…",
    muteAll: "Hide all alerts…",
    muteTitle: { one: "Hide this alert", other: "Hide these alerts" },
    muteDescription:
      "The media will no longer be in alert for {alerts}: no notification, no automation. As soon as the situation changes, the alert comes back automatically.",
    unmute: "Show “{status}” again",
    mutedHint: "Hidden alert: comes back automatically if the situation changes.",
    quoted: "“{name}”",
    note: "Note (optional)",
    notePlaceholder: "Why ignore it?",
    confirm: "Ignore",
    done: "Noted: the alert comes back on its own if the situation changes.",
    undone: "Reported again.",
    failed: "Action failed.",
    muteUntracked: "Hide the “{status}” alert",
    title: "Ignored items",
    description:
      "Ignored torrents, files kept on purpose and hidden alerts. Each one is reported again automatically as soon as its situation changes.",
    empty: "Nothing is ignored yet. Use the ⋯ menu of a media page, a torrent or a file.",
    kinds: {
      torrent: "Ignored torrent",
      file: "Kept file",
      status: "Hidden alert",
    },
    absent: "Not found at the last scan",
  },
  trash: {
    title: "Trash",
    description:
  ...
  notifications: {
    ...
    eventHelp: {
      ...
      arr_link: "A library media was added to Sonarr/Radarr.",
  ...
  history: {
    ...
    actions: {
      ...
      arr_link: "Link",
      ignore: "Ignored",
      unignore: "No longer ignored",
      ignore_expired: "Reported again",
    },
  ...
  filters: {
    ...
    muted: "Hidden alerts",
    more: "Filters",
    matchAll: "Combine statuses",
    matchAllHelp:
      "On: only media carrying ALL the checked statuses. Off: those carrying at least one.",
    movies: "Movies",
    series: "Series",
    status: "Status",
    sortBy: "Sort by",
