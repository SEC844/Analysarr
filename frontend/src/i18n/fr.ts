...
export const fr = {
  ...
  notifications: {
    ...
    description: "Recevez un message sur Discord, ntfy ou Gotify. Les adresses et jetons restent secrets, jamais réaffichés.",
    configured: "Configuré",
    remove: "Retirer",
    willBeRemoved: "Ce canal sera retiré à l'enregistrement.",
    discordWebhook: "URL du webhook",
    discordHelp: "Discord → Paramètres du salon → Intégrations → Webhooks → Copier l'URL.",
    ntfyUrl: "URL du sujet",
    ntfyHelp: "Ex : https://ntfy.sh/nom-de-sujet. Sur un serveur public, le nom du sujet fait office de mot de passe : choisissez-le difficile à deviner.",
    ntfyToken: "Jeton d'accès (optionnel)",
    gotifyUrl: "URL du serveur",
    gotifyToken: "Jeton d'application",
    gotifyHelp: "Gotify → Apps → Créer une application, puis copier son jeton.",
    eventsTitle: "Événements",
    eventsDescription: "Choisissez quand être notifié.",
    onScan: "Scan terminé",
    onScanHelp: "Résumé après chaque scan réussi, manuel ou planifié.",
    onScanFailure: "Échec d'un scan",
    onScanFailureHelp: "Service injoignable ou configuration incomplète.",
    onActions: "Actions effectuées",
    onActionsHelp: "Suppressions, nettoyages et réparations de hardlinks.",
    test: "Envoyer un test",
    testHint: "Utilise les canaux enregistrés : enregistrez vos changements avant de tester.",
    testSuccess: "Notification de test envoyée : {channels}.",
