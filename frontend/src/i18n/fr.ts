...
export const fr = {
  ...
  ignore: {
    options: "Options",
    ignoreTorrent: "Ignorer ce torrent…",
    ignoreTorrentTitle: "Ignorer ce torrent",
    ignoreTorrentDescription:
      "Il ne sera plus signalé orphelin ni non hardlinké, et ni « Nettoyer », ni « Réparer », ni les automatisations n'y toucheront. Si sa situation change, il est de nouveau signalé automatiquement.",
    unignore: "Ne plus ignorer",
    ignored: "Ignoré",
    ignoredHint: "Ignoré : de nouveau signalé automatiquement si sa situation change.",
    keepFile: "Garder volontairement…",
    keepFileTitle: "Garder ce fichier volontairement",
    keepFileDescription:
      "Il ne comptera plus comme doublon et ne sera jamais nettoyé — par exemple une VF et une VOSTFR côte à côte. S'il est remplacé, l'alerte revient automatiquement ; un nouveau doublon reste signalé.",
    unkeepFile: "Ne plus garder",
    kept: "Gardé volontairement",
    keptHint: "Gardé volontairement : de nouveau signalé automatiquement s'il change.",
    muteAlert: "Masquer « {status} »…",
    muteAll: "Masquer toutes les alertes…",
    muteTitle: { one: "Masquer cette alerte", other: "Masquer ces alertes" },
    muteDescription:
      "Le média ne sera plus en alerte pour {alerts} : ni notification, ni automatisation. Dès que la situation change, l'alerte revient automatiquement.",
    unmute: "Réafficher « {status} »",
    mutedHint: "Alerte masquée : réactivée automatiquement si la situation change.",
    quoted: "« {name} »",
    note: "Note (facultative)",
    notePlaceholder: "Pourquoi l'ignorer ?",
    confirm: "Ignorer",
    done: "C'est noté : l'alerte revient d'elle-même si la situation change.",
    undone: "De nouveau signalé.",
    failed: "Action impossible.",
    muteUntracked: "Masquer l'alerte « {status} »",
    title: "Éléments ignorés",
    description:
      "Torrents ignorés, fichiers gardés volontairement et alertes masquées. Chacun redevient signalé automatiquement dès que sa situation change.",
    empty: "Rien n'est ignoré pour l'instant. Utilisez le menu ⋯ d'une fiche média, d'un torrent ou d'un fichier.",
    kinds: {
      torrent: "Torrent ignoré",
      file: "Fichier gardé",
      status: "Alerte masquée",
    },
    absent: "Introuvable à la dernière analyse",
  },
  trash: {
    title: "Corbeille",
    description:
  ...
  history: {
    ...
    actions: {
      ...
      ignore: "Ignoré",
      unignore: "Plus ignoré",
      ignore_expired: "De nouveau signalé",
    },
