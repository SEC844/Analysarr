...
export function useScanRunner() {
  ...
  const start = useCallback(
    (scope: ScanScope = "full") => {
      ...
      // On s'abonne au flux SSE AVANT de déclencher l'analyse, pour ne pas
      // rater les premiers événements si elle démarre plus vite que la
      ...
      // (proxy qui met la réponse en tampon), l'analyse est lancée quand même
      // plutôt que de rester indéfiniment sur « Démarrage du scan... ».
