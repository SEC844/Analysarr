...
- Corbeille optionnelle : les fichiers qu'Analysarr supprime lui-même sont mis de côté et restent récupérables quelques jours, avec restauration en un clic (**Réglages → Corbeille**).
