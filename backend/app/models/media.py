...
class Media(SQLModel, table=True):
    ...
    emby_date_added: datetime | None = None
    episode_count: int = 0
...
class Torrent(SQLModel, table=True):
    ...
    id: int | None = Field(default=None, primary_key=True)
    media_id: int | None = Field(default=None, foreign_key="media.id", index=True)
